...
public class TileJ extends Tile {
     ...
     *
     * So for example, if we want to find where R is in TileJ,
     * for orientation 2 it will be x+0
     *
     * yOffsets are just previous orientation's xOffsets
     */

    private Color[] colorArray = {G,G,G,W,R};
    private int[][] xOffsets = {{0,0,1,2,3},{0,1,1,1,1},{3,3,2,1,0},{1,0,0,0,0}};

    public TileJ (TileType tileType, Orientation orientation, Location location) {
