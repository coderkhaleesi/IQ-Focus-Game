...
public class TileF extends Tile {
     ...
     *
     * So for example, if we want to find where W is in TileF,
     * for orientation 0 it will be x+0, x+1 and x+2 for different y
     *
     * yOffsets are just previous orientation's xOffsets
     */
    private Color[] colorArray = {W,W,W};
    private int[][] xOffsets = {{0,1,2},{0,0,0},{0,1,2},{0,0,0}};

    public TileF (TileType tileType, Orientation orientation, Location location) {
